...
echo "- Block base interval: ${BLOCK_BASE_INTERVAL}s"
echo "- Block max interval: ${BLOCK_MAX_INTERVAL}s"
echo "- Fail base interval: ${FAIL_BASE_INTERVAL}s"
echo "- Fail max interval: ${FAIL_MAX_INTERVAL}s"
echo "- Config refresh interval: every $config_refresh_interval runs"
echo ""
